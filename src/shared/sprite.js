module.exports = {
    ...
    "AboutusMembers": {
        "MemberAvatar": {
            ...
            "width": "112px",
            "height": "112px",
            "backgroundImage": "url('http://127.0.0.1:3030/images/sprites/sprite-aboutus-members.png')",
    ...
    "HomeBanner": {
        "Insurance": {
            ...
            "width": "256px",
            "height": "256px",
            "backgroundImage": "url('http://127.0.0.1:3030/images/sprites/sprite-home-banner.png')",
    ...
    "Procedures": {
        "BackToMenu": {
            ...
            "width": "32px",
            "height": "19px",
            "backgroundImage": "url('http://127.0.0.1:3030/images/sprites/sprite-procedures.png')",
    ...
    "Seguros": {
        "SegurosMxServicio": {
            ...
            "width": "142px",
            "height": "81px",
            "backgroundImage": "url('http://127.0.0.1:3030/images/sprites/sprite-seguros.png')",
    ...
    "Services": {
        "Bullet": {
            ...
            "width": "12px",
            "height": "12px",
            "backgroundImage": "url('http://127.0.0.1:3030/images/sprites/sprite-services.png')",
